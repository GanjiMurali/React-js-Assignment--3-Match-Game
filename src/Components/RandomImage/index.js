...
class RandomImage extends Component {
  ...
  resetButton = () => {
    this.setState({valueNum: 0, timerInSeconds: 60, gameStatus: false})
    this.timerId = setInterval(this.tick, 1000)
  }
  ...
  clickImageItem = imageId => {
    ...
    if (topImage.id === imageId) {
      this.setState(prevState => ({valueNum: prevState.valueNum + 1}))
      this.setState({
        topImage:
  ...
  render() {
    ...
    return (
      <div className="container">
        <NavbarContainer valueNum={valueNum} timerInSeconds={timerInSeconds} />
        {gameStatus ? (
          <div className="body-container">
            <div className="pop-up-container">
              ...
              <h1 className="score">{valueNum}</h1>
              <button
                type="button"
          ...
          <div className="body-container">
            <img src={topImage.imageUrl} alt="match" className="main-img" />
            ...
            <ul className="image-list-container">
              {filteredItems.map(eachItemDetails => (
                <ImagesContainer
                  eachItemDetails={eachItemDetails}
                  key={eachItemDetails.thumbnailUrl}
